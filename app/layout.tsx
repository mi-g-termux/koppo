...
export const metadata: Metadata = {
  title: "MIR Labs — Full-stack developer & product builder",
  description:
    "MIR Labs portfolio — commerce platforms, dashboards, automation and high-design web experiences.",
  authors: [{ name: "MIR Labs" }],
  icons: {
    icon: [
  ...
  openGraph: {
    title: "MIR Labs",
    description: "A 3D portfolio of commerce platforms, dashboards and high-design web experiences.",
    type: "website",
    locale: "en_US",
  },
  twitter: {
